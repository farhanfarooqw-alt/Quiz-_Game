...
| Difficulty Levels   | Easy, Medium, Hard — each with different scoring rules                       |
| Lifelines           | Use hints or skips to help during tough questions                            |
| Score Tracking      | Earn points for correct answers, with bonus streaks                          |
| Leaderboard         | High scores saved in a file and shown across sessions                        |
| Review Mode         | See which questions you got wrong after finishing                            |
| Game Logs           | Every quiz attempt is saved for future review                                |
